...
CCFLAGS=$(CCINCLUDES) -DLINUX -D_GNU_SOURCE -D_REENTRANT -g -Wno-narrowing
LDFLAGS=-g -Wno-narrowing
endif
OL8_VER := $(shell /bin/grep -i "Oracle Linux Server release 8" /etc/oracle-release)
ifdef OL8_VER
	CC=/usr/bin/g++
	cc=/usr/bin/gcc
	CCFLAGS=$(CCINCLUDES) -DLINUX -D_GNU_SOURCE -D_REENTRANT -g -Wno-narrowing
