...
*/
      void setNodeValue( oratext* data) ;
...
*/
      Node* removeChild( NodeRef& oldChild) ;
...
*/
      Node* appendChildWithPtr( Node* newChildPtr) ;
...
/*---------------------------------------------------------------------
    ...
    ARGUMENTS
        name (IN) name
*/
      Node* createAttribute( oratext* name) ;
...
/*---------------------------------------------------------------------
    ...
    ARGUMENTS
        name (IN) name
*/
      Node* createEntityReference( oratext* name) ;
...
/*---------------------------------------------------------------------
    ...
    ARGUMENTS
        name (IN) attribute's name [data encoding]
*/
      void removeAttribute( oratext* name) ;
...
*/
      oratext* substringData( ub4 offset, ub4 count) ;
...
*/
      void insertData( ub4 offset, oratext* data) ;
...
*/
      void deleteData( ub4 offset, ub4 count) ;
...
*/
      Node* removeNamedItem( oratext* name) ;
...
*/
      virtual void loadSchema( oratext* schema_URI) = 0;
...
/*---------------------------------------------------------------------
    ...
    ARGUMENTS
        schema_URI (IN) URL of schema document [compiler encoding]
*/
      virtual void unloadSchema( oratext* schema_URI) = 0;
...
*/
      virtual void validate( ElementRef< Node>& elem_ref) = 0;
...
*/
      virtual void validate( InputSource* isrc_ptr) = 0;
...
*/
      ...
      parseDTD( InputSource* src_ptr, boolean no_mod = FALSE,
		DOMImplementation< Node>* impl_ptr = NULL) = 0;
...
*/
      ...
      parseSchVal( InputSource* src_par, boolean no_mod = FALSE,
		   ...
		   SchemaValidator< Node>* tor_ptr = NULL) = 0;
...
*/
      virtual void parseDTD( InputSource* src_ptr,
			     SAXHandlerRoot* hdlr_ptr = NULL) = 0;
...
*/
      virtual ubig_ora
      writeNode( OutputSource* osrc_ptr, NodeRef< Node>& node_ref) = 0;
...
*/
      virtual void setXSL (InputSource* isrc_ptr) = 0;
...
*/
      virtual void setTextParam( oratext *name, oratext *value) = 0;
...
*/
      virtual void setOutputEncoding( oratext* encoding) = 0;
...
*/
      virtual void setBinXsl (ub2* binxsl_ptr) = 0;
...
*/
      virtual ub2* compile( InputSource* isrc_ptr) = 0;
...
*/
      virtual ub4 getLength( ub2* binxsl_ptr)	= 0;
...
*/
      ...
      process( InputSource* isrc_ptr, oratext* xpath_exp) = 0;
...
*/
      virtual XPathObject< Node>*
      processWithBinXPath( InputSource* isrc_ptr, ub2* bin_xpath) = 0;
...
/*---------------------------------------------------------------------
    ...
    ARGUMENTS
        xpath_exp    (IN) XPath expression
*/
      virtual ub2* compile( oratext* xpath_exp) = 0;
